...
Every employee must receive a **written appointment letter** with designation, wages, category and social-security details. Small employers who hired on a handshake must issue letters retrospectively. The [experience letter tool](/tools/experience-letter) has a companion letterhead format you can adapt.
...
Monthly wages must be paid by the **7th of the following month**. Deductions are capped at 50% of wages. Wage slips are mandatory — the [wage slip generator](/tools/wage-slip) prints thermal or A5 slips in seconds.
...
1. Restructure salaries so basic + DA ≥ 50% of CTC; re-issue CTC letters.
2. Issue appointment letters to everyone without one.
3. Set up gratuity provision for fixed-term staff; review contract lengths.
4. Fix payroll date to on or before the 7th; adopt wage slips.
5. Update your overtime policy and time-tracking.
6. Check your state's rules for thresholds on leave, working hours and night-shift conditions.
7. Recompute per-head cost with the [team payroll calculator](/tools/team-payroll).
