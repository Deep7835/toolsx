---
title: "GST 2.0 rate changes: what every shopkeeper, trader and freelancer needs to update"
description: "The 22 September 2025 overhaul collapsed four GST slabs into two (5% and 18%) with a 40% rate for sin goods. Here is what moved, what stayed, and the five things to fix in your billing this week."
date: "2026-09-12"
updated: "2026-09-18"
kind: trending
tags: [gst, billing, retail]
...
- **Composition dealers.** Your rate (1%, 5% for restaurants, 6% for services) did not change, but your *input* costs did. If most of your purchases fell to 5%, the composition trade-off is now slightly less attractive. Run the numbers with the [GST calculator's composition comparison](/tools/gst-calculator).
...
1. **Update the rate on every product master.** In Tally, Vyapar, Zoho, or even a spreadsheet — the HSN stays the same, only the rate changes. Use the [HSN/SAC finder](/tools/hsn-finder) to spot-check anything you are unsure about.
2. **Reprint price tags and menus.** MRP is inclusive of all taxes; if your supplier reprinted MRP you must sell at the new MRP. The [price tag generator](/tools/price-tag-generator) makes a sheet in a minute.
3. **Check your invoice template.** Templates that hard-code "12%" or "28%" in a dropdown will let staff pick a dead rate. The [GST invoice generator](/tools/gst-invoice) still offers 12% and 28% for back-dated bills but defaults to the live slabs.
4. **Reconcile September 2025 carefully.** That month had both rate structures. Supplies made on or before 21 September carry the old rate even if you invoiced later; the *time of supply* rules decide.
5. **Tell customers.** A small "Prices reduced — GST 2.0" note at the counter converts curiosity into sales and pre-empts arguments about old stock.
...
Search by product name or HSN code in the [HSN/SAC finder](/tools/hsn-finder). For disputes, the CBIC rate schedule and the Council's FAQ are the authority.
