...
export default function About() {
  return (
    <ProsePage eyebrow="Company" title="About India Biz Tools" description="A free, private toolbox for the people who run India’s shops, clinics, agencies and side hustles.">
      <p>India has over 60 million micro, small and medium businesses. Most of them still run on paper bills, WhatsApp photos and a calculator app. India Biz Tools exists so a kirana owner in Kanpur or a freelance designer in Kochi can produce a GST-compliant invoice, a UPI QR standee or a payroll slip in under a minute — without installing software, creating an account, or paying a subscription.</p>
      <h2>Principles</h2>
      <ul>
