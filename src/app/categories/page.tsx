...
export const metadata: Metadata = { title: "Tool categories", description: "Browse every free tool by job: billing, GST & tax, HR & payroll, finance, marketing & QR, logistics, shop, media, freelancer and legal.", alternates: { canonical: "/categories" }, robots: { index: false, follow: true } };
