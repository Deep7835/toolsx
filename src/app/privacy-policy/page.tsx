...
export default function Privacy() {
  return (
    <ProsePage eyebrow="Legal" title="Privacy policy" description="Short version: we can’t see your data, because it never leaves your device.">
      ...
      <p>By default we set no tracking cookies. Your theme, favourites, saved business details and cookie choice are kept in your browser’s local storage. If analytics is enabled on this site, it runs only after you choose “Accept analytics” in the cookie banner; it collects anonymised page-view statistics (IP addresses are anonymised, no advertising cookies). You can change your choice at any time by clearing site data in your browser. Where cookie-free analytics (such as Plausible) is used, no personal data or cookies are involved.</p>
      <h2>Contact form</h2>
