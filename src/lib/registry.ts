...
const RAW: ToolMeta[] = [
  ...
  t("upi-mdr-calculator", "UPI MDR Calculator 2026", "Calculate UPI MDR charges in India, including the 0.4% standard rate, ₹300 cap, small merchant exemptions and P2PM rules.", "finance", "BUSINESS FINANCE", "NPCI 2026", { badge: "updated", keywords: ["mdr", "merchant fee"] }),
