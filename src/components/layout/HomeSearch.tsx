...
export function HomeSearch() {
  ...
  return (
    <form
      ...
      className="relative"
    >
      <div className="flex items-center gap-2 rounded-2xl border border-border bg-surface p-1.5 shadow-md focus-within:border-accent focus-within:ring-4 focus-within:ring-accent/10 transition">
        ...
        <button type="submit" className="h-11 shrink-0 rounded-xl bg-ink px-5 text-sm font-medium text-bg transition-colors hover:bg-ink-2 dark:bg-accent dark:text-on-accent dark:hover:bg-accent-hover cursor-pointer">Search</button>
      </div>
      {q && results.length ? (
